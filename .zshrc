...
# for a note.md shortcut
alias note="nvim ~/Documents/Markdown/DailyNote/$(date '+%Y.%m.%d').md"

# for ttyrec alias (terminal gif record)
alias ta="ttyrec -a"
alias tg="ttygif"
...
# default editor is set to nvim in ranger
export VISUAL=nvim
...
# set go language workpath
export GOPATH=$HOME/Documents/MyProgram/Go
...
export NO_PROXY=localhost,127.0.0.1,::1 # set no proxy for flutter
...
# export OPENBLAS ( for python science calc )
...
# the iterm2 enhance integration
test -e "${HOME}/.iterm2_shell_integration.zsh" && source "${HOME}/.iterm2_shell_integration.zsh"


# environment of configuration nvm
export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion


# turn on the starship prompt style
